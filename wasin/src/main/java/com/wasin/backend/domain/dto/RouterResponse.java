...
public class RouterResponse {
    ...
    public record EachRouter (String name, String state, Double positionX, Double positionY) { }

    public record CompanyImageDTO(String companyImage, Integer imageHeight, Integer imageWidth){ }

    public record RouterInformationDTO(String name, String ssid, String state, Double positionX, Double positionY){ }
